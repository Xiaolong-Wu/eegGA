function prosess_featureAnalysisShowViolin(EEG_featureGroup,meth,n_channel,r_channel,C_range,title_show,Title)
...
for r1=1:n_feature
    ...
    for r2=r_channel
        ...
        switch meth
            case {'bandPower';'morphology';'CFC_bandPowerRate';'CFC_morphologyRate';'timeFeature';'morphTimeFeature'}
                r0=r0+1;
                x{1,r0}=EEG_featureGroup.all{r1,1}{1,r2};
            ...
            case {'correlation';'morphCorrelation'}
                ...
                for r3=r_channel
                    ...
                    if r3>r2
                        r0=r0+1;
                        x{1,r0}=EEG_featureGroup.all{r1,1}{r2,r3};
    ...
    violin(x,'xlabel',Labels,'facecolor','w','edgecolor','k');
    ylim(C_range);
